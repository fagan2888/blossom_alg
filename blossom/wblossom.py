'''
developed based on the materials below:

lectures: https://www.arl.wustl.edu/~jst/cse/542/, mainly JST15 and JST 16
papers: http://www.cs.kent.edu/~dragan/GraphAn/p23-galil.pdf

the complexity and speed of the algorithm implemented below is not optimized, so this is just a proof of ideas
instead of a robust module for product
'''
